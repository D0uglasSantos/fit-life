...
import Logo from "/public/fitLife-logo-500-200.png";
  ...
  return (
    <footer className="bg-color-primary h-max py-12 flex flex-col items-center justify-center space-y-2 ">
      ...
      <div className=" w-10/12 text-center space-y-5 border-b-2 py-5">
        <h1 className="text-sm text-white">Siga-nos</h1>
      ...
      <div className="text-center w-10/12 space-y-3 py-5">
        ...
        <p className="text-zinc-400 text-[8px]">faleconosco@fitlife.com</p>
        <p className="text-zinc-400 text-xs">CNPJ: 48.122.679/0001-18</p>
      </div>
    </footer>
  );
};
